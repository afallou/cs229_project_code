...
% Date: June 2012
%
function [processed_video_matrix] = amplify_spatial_Gdown_temporal_ideal(vidFile,outDir,alpha,level, ...
    ...
    % samplingRate: sampling rate for ideal band pass filter
    % chromAttenuation: amplification factor (< 1) for color channels 2 and 3
